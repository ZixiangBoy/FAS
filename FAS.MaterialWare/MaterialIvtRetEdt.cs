...
{
    public partial class MaterialIvtRetEdt : DialogViewEx
    {
        public MaterialIvtRetEdt()
        {
            InitializeComponent();
        }
        ...
        {
            var ds = gcSt.GetDataSource<UltraDbEntity.T_ERP_MaterialIvtAdj>();
            ...
            var rd = SerNoCaller_GC.Calr_MaterialIvtAdj.Add(ds);
            ...
            //创建入库调整单
            var vt = SerNoCaller_GC.Calr_MaterialIvtAdj.ExecSql("exec P_ERP_NMaterialAdj @0", session);
        ...
        private void gcStock_RowCellDoubleClick(object sender, MouseEventArgs e)
        {
            ...
            if (null == ett) return;
            var et = ett.MapTo<UltraDbEntity.T_ERP_InventoryMaterial, UltraDbEntity.T_ERP_MaterialIvtAdj>();
            if (et == null) return;
            ...
            var ds = gcSt.GetDataSource<UltraDbEntity.T_ERP_MaterialIvtAdj>();
            ds = ds ?? new List<UltraDbEntity.T_ERP_MaterialIvtAdj>();
