...
namespace UltraDbEntity {
    public partial class T_ERP_Trade {

        [Ignore]
        public string ColorField {
            get {
                return IsUrgent ? "255,240,100,192" : string.Empty;
            }
        }
    }

    public partial class T_ERP_Order {

        [Ignore]
        public string ColorField {
            get {
                return IsProd ? "255,240,100,192" : string.Empty;
            }
        }
    }

    public partial class T_ERP_OrderPrd {
