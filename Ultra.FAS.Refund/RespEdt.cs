...
{
    public partial class RespEdt : DialogViewEx
    {
        public RespEdt()
        {
            InitializeComponent();
        ...
        public UltraDbEntity.T_ERP_Responsible Entity { get; set; }

        public CoreCaller.EFCaller<UltraDbEntity.T_ERP_Responsible> Calr { get; set; }
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            {
                var rd = Calr.Add(new UltraDbEntity.T_ERP_Responsible
                {
                    Guid = Guid.NewGuid(),
                    Creator = CurUser,
                    Updator = CurUser,
                    ...
                    Reserved3 = false,
                    Remark = string.Empty,
                    ResponsibleName = labelTextBox1.Text,
        ...
        private void EdtView_Load(object sender, EventArgs e)
        {
            if (null != Entity && EditMode == Business.Core.Define.EnViewEditMode.Edit)
            {
                ...
                labelTextBox1.Text = Entity.ResponsibleName;
