...
{
    public partial class RespView : MainSurface, ISurfacePermission
    {
        public RespView()
        {
            InitializeComponent();
        ...
        public List<PermitGridView> Grids
        {
            get
            {
                ...
                {
                    new PermitGridView(this.gridView1,"责任方")
                };
            }
        }
        ...
        public EFCaller<UltraDbEntity.T_ERP_Responsible> Calr { get; set; }

        private void MainView_Load(object sender, EventArgs e)
        {
            Calr = SerNoCaller_WL.Calr_Responsible;
        ...
        {
            var et = gridView1.GetFocusedDataSource<UltraDbEntity.T_ERP_Responsible>();
