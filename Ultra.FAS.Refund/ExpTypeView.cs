...
{
    public partial class ExpTypeView : MainSurface, ISurfacePermission
    {
        public ExpTypeView()
        {
            InitializeComponent();
        ...
        public List<PermitGridView> Grids
        {
            get
            {
                ...
                {
                    new PermitGridView(this.gridView1,"费用类型")
                };
            }
        }
        ...
        public EFCaller<UltraDbEntity.T_ERP_ExpensesType> Calr { get; set; }

        private void MainView_Load(object sender, EventArgs e)
        {
            Calr = SerNoCaller_WL.Calr_ExpensesType;
        ...
        {
            var et = gridView1.GetFocusedDataSource<UltraDbEntity.T_ERP_ExpensesType>();

            var vw = new ExpTypeEdt();
            vw.Calr = this.Calr;
            vw.Entity = et;
