...
{
    public partial class ExpTypeEdt : DialogViewEx
    {
        public ExpTypeEdt()
        {
            InitializeComponent();
        ...
        public UltraDbEntity.T_ERP_ExpensesType Entity { get; set; }

        public CoreCaller.EFCaller<UltraDbEntity.T_ERP_ExpensesType> Calr { get; set; }
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            {
                var rd = Calr.Add(new UltraDbEntity.T_ERP_ExpensesType
                {
                    Guid = Guid.NewGuid(),
                    Creator = CurUser,
                    Updator = CurUser,
