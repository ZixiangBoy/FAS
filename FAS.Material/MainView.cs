    ...
    public partial class MainView : MainSurface, ISurfacePermission {
        ...
        public List<PermitGridView> Grids {
            get {
                ...
                new PermitGridView(this.gridView1,"物料管理")
            };
            }
        }
        ...
        private void MainView_Load(object sender, EventArgs e) {
            ...
            materialPager1.Caller = SerNoCaller.Calr_Material;
        }
        ...
        void barBtnEdt_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e) {
            var et = gridView1.GetFocusedDataSource<UltraDbEntity.T_ERP_Material>();
            if (null == et) return;
            var vw = new EdtView();
        ...
        void barBtnRefresh_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e) {
            materialPager1.CurrentPage = 1;
            materialPager1.PrefixWhr = "select * from T_ERP_Material";
            materialPager1.Whrs.Clear(); materialPager1.PrmsData.Clear();
            materialPager1.OrderBy = " order by id desc";
            materialPager1.BindPageData();
        }
